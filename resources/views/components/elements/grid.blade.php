        ...
        <div class="col d-block" onclick="{{ $cellOnClickCallback }}">
            <div class="ingredient-card d-block">
                ...
                <div class="ingredient-card-text-{{ $recipe->id }} d-block mt-1">
                    ...
                    <div class="ingredient-card-qty d-none ingredientDQty-{{ $recipe->id }}">{{ $ingredient->pivot->qty ?? null }}</div>
                    <div class="ingredient-card-description d-none ingredientDescription-{{ $recipe->id }}">{{ $ingredient->pivot->description ?? null }}</div>
                </div>
            </div>
        </div>
        @endforeach
